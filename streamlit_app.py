...
def encode_inputs(product_category, shipping_method, customer_location, order_volume, distance):
...
if st.button("Predict Delivery Time"):
    ...
    input_features = encode_inputs(product_category, shipping_method, customer_location, order_volume, distance)
